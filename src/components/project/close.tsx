...
cursor-pointer rounded-full border border-2 border-text-main w-12 h-12 text-text-main flex justify-center items-center hover:bg-text-main hover:text-primary
`;
